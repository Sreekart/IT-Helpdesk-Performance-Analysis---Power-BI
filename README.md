...
**SLA Compliance**
![SLA Compliance Dashboard](SLA%20Analysis.png)

**Agent Performance**
![Agent Performance Dashboard](Agent%20Analysis.png)
...
1. Clone the repo
2. Open `IT Helpdesk Performance Analysis.pbix` in Power BI Desktop
